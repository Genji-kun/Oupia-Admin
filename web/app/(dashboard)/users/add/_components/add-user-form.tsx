...
const AddUserForm = () => {
    ...
    return (
        <div className="flex flex-col gap-2 py-5 container">
            <Form {...form}>
                                    ...
                                    <div className="flex gap-6 items-center">
                                        ...
                                        <div className="w-full space-y-2 max-w-xl">
                                            ...
                                            <Input
                                                ...
                                                className="text-base dark:bg-slate-900 mt-2"
                                                ref={fileInputRef}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem >
                                ...
                                <FormControl>
                                    <Input {...field} type="text" disabled={isSubmitting} className="text-base  dark:bg-slate-900" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem >
                                ...
                                <FormControl>
                                    <Input {...field} type="email" disabled={isSubmitting} className="text-base dark:bg-slate-900" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input {...field} type="phone" disabled={isSubmitting} className="text-base dark:bg-slate-900" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem >
                                    ...
                                    <FormControl>
                                        <Input {...field} type="password" disabled={isSubmitting} className="text-base dark:bg-slate-900" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
